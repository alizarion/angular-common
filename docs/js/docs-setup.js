NG_DOCS={
  ...
  "pages": [
    ...
    {
      "section": "api",
      "id": "dependencies.directive:icon",
      "shortName": "icon",
      "type": "directive",
      "moduleName": "dependencies",
      "shortDescription": "Font Awesome gives you scalable vector icons that can instantly be customized — size, color, drop shadow, and anything that can be done with the power of CSS.",
      "keywords": "$scope accessibility adblock alert alert-link alert-success alert-warning angular animated api application aria-hidden awesome bean block brand buttons chart check checked class col-md-3 col-sm-4 color company control controller css currency customized dependencies directional directive display drop editor ellipsis endorsement error example fa fa-500px fa-adjust fa-adn fa-align-center fa-align-justify fa-align-left fa-align-right fa-amazon fa-ambulance fa-american-sign-language-interpreting fa-anchor fa-android fa-angellist fa-angle-double-down fa-angle-double-left fa-angle-double-right fa-angle-double-up fa-angle-down fa-angle-left fa-angle-right fa-angle-up fa-apple fa-archive fa-area-chart fa-arrow-circle-down fa-arrow-circle-left fa-arrow-circle-o-down fa-arrow-circle-o-left fa-arrow-circle-o-right fa-arrow-circle-o-up fa-arrow-circle-right fa-arrow-circle-up fa-arrow-down fa-arrow-left fa-arrow-right fa-arrow-up fa-arrows fa-arrows-alt fa-arrows-h fa-arrows-v fa-asl-interpreting fa-assistive-listening-systems fa-asterisk fa-at fa-audio-description fa-automobile fa-backward fa-balance-scale fa-ban fa-bank fa-bar-chart fa-bar-chart-o fa-barcode fa-bars fa-battery-0 fa-battery-1 fa-battery-2 fa-battery-3 fa-battery-4 fa-battery-empty fa-battery-full fa-battery-half fa-battery-quarter fa-battery-three-quarters fa-bed fa-beer fa-behance fa-behance-square fa-bell fa-bell-o fa-bell-slash fa-bell-slash-o fa-bicycle fa-binoculars fa-birthday-cake fa-bitbucket fa-bitbucket-square fa-bitcoin fa-black-tie fa-blind fa-bluetooth fa-bluetooth-b fa-bold fa-bolt fa-bomb fa-book fa-bookmark fa-bookmark-o fa-braille fa-briefcase fa-btc fa-bug fa-building fa-building-o fa-bullhorn fa-bullseye fa-bus fa-buysellads fa-cab fa-calculator fa-calendar fa-calendar-check-o fa-calendar-minus-o fa-calendar-o fa-calendar-plus-o fa-calendar-times-o fa-camera fa-camera-retro fa-car fa-caret-down fa-caret-left fa-caret-right fa-caret-square-o-down fa-caret-square-o-left fa-caret-square-o-right fa-caret-square-o-up fa-caret-up fa-cart-arrow-down fa-cart-plus fa-cc fa-cc-amex fa-cc-diners-club fa-cc-discover fa-cc-jcb fa-cc-mastercard fa-cc-paypal fa-cc-stripe fa-cc-visa fa-certificate fa-chain fa-chain-broken fa-check fa-check-circle fa-check-circle-o fa-check-square fa-check-square-o fa-chevron-circle-down fa-chevron-circle-left fa-chevron-circle-right fa-chevron-circle-up fa-chevron-down fa-chevron-left fa-chevron-right fa-chevron-up fa-child fa-chrome fa-circle fa-circle-o fa-circle-o-notch fa-circle-thin fa-clipboard fa-clock-o fa-clone fa-close fa-cloud fa-cloud-download fa-cloud-upload fa-cny fa-code fa-code-fork fa-codepen fa-codiepie fa-coffee fa-cog fa-cogs fa-columns fa-comment fa-comment-o fa-commenting fa-commenting-o fa-comments fa-comments-o fa-compass fa-compress fa-connectdevelop fa-contao fa-copy fa-copyright fa-creative-commons fa-credit-card fa-credit-card-alt fa-crop fa-crosshairs fa-css3 fa-cube fa-cubes fa-cut fa-cutlery fa-dashboard fa-dashcube fa-database fa-deaf fa-deafness fa-dedent fa-delicious fa-desktop fa-deviantart fa-diamond fa-digg fa-dollar fa-dot-circle-o fa-download fa-dribbble fa-dropbox fa-drupal fa-edge fa-edit fa-eject fa-ellipsis-h fa-ellipsis-v fa-empire fa-envelope fa-envelope-o fa-envelope-square fa-envira fa-eraser fa-eur fa-euro fa-exchange fa-exclamation fa-exclamation-circle fa-exclamation-triangle fa-expand fa-expeditedssl fa-external-link fa-external-link-square fa-eye fa-eye-slash fa-eyedropper fa-facebook fa-facebook-f fa-facebook-official fa-facebook-square fa-fast-backward fa-fast-forward fa-fax fa-feed fa-female fa-fighter-jet fa-file fa-file-archive-o fa-file-audio-o fa-file-code-o fa-file-excel-o fa-file-image-o fa-file-movie-o fa-file-o fa-file-pdf-o fa-file-photo-o fa-file-picture-o fa-file-powerpoint-o fa-file-sound-o fa-file-text fa-file-text-o fa-file-video-o fa-file-word-o fa-file-zip-o fa-files-o fa-film fa-filter fa-fire fa-fire-extinguisher fa-firefox fa-flag fa-flag-checkered fa-flag-o fa-flash fa-flask fa-flickr fa-floppy-o fa-folder fa-folder-o fa-folder-open fa-folder-open-o fa-font fa-fonticons fa-fort-awesome fa-forumbee fa-forward fa-foursquare fa-frown-o fa-futbol-o fa-gamepad fa-gavel fa-gbp fa-ge fa-gear fa-gears fa-genderless fa-get-pocket fa-gg fa-gg-circle fa-gift fa-git fa-git-square fa-github fa-github-alt fa-github-square fa-gitlab fa-gittip fa-glass fa-glide fa-glide-g fa-globe fa-google fa-google-plus fa-google-plus-square fa-google-wallet fa-graduation-cap fa-gratipay fa-group fa-h-square fa-hacker-news fa-hand-grab-o fa-hand-lizard-o fa-hand-o-down fa-hand-o-left fa-hand-o-right fa-hand-o-up fa-hand-paper-o fa-hand-peace-o fa-hand-pointer-o fa-hand-rock-o fa-hand-scissors-o fa-hand-spock-o fa-hand-stop-o fa-hard-of-hearing fa-hashtag fa-hdd-o fa-header fa-headphones fa-heart fa-heart-o fa-heartbeat fa-history fa-home fa-hospital-o fa-hotel fa-hourglass fa-hourglass-1 fa-hourglass-2 fa-hourglass-3 fa-hourglass-end fa-hourglass-half fa-hourglass-o fa-hourglass-start fa-houzz fa-hover fa-html5 fa-i-cursor fa-ils fa-image fa-inbox fa-indent fa-industry fa-info fa-info-circle fa-inr fa-instagram fa-institution fa-internet-explorer fa-intersex fa-ioxhost fa-italic fa-joomla fa-jpy fa-jsfiddle fa-key fa-keyboard-o fa-krw fa-language fa-laptop fa-lastfm fa-lastfm-square fa-leaf fa-leanpub fa-legal fa-lemon-o fa-level-down fa-level-up fa-lg fa-li fa-life-bouy fa-life-buoy fa-life-ring fa-life-saver fa-lightbulb-o fa-line-chart fa-link fa-linkedin fa-linkedin-square fa-linux fa-list fa-list-alt fa-list-ol fa-list-ul fa-location-arrow fa-lock fa-long-arrow-down fa-long-arrow-left fa-long-arrow-right fa-long-arrow-up fa-low-vision fa-magic fa-magnet fa-mail-forward fa-mail-reply fa-mail-reply-all fa-male fa-map fa-map-marker fa-map-o fa-map-pin fa-map-signs fa-mars fa-mars-double fa-mars-stroke fa-mars-stroke-h fa-mars-stroke-v fa-maxcdn fa-meanpath fa-medium fa-medkit fa-meh-o fa-mercury fa-microphone fa-microphone-slash fa-minus fa-minus-circle fa-minus-square fa-minus-square-o fa-mixcloud fa-mobile fa-mobile-phone fa-modx fa-money fa-moon-o fa-mortar-board fa-motorcycle fa-mouse-pointer fa-music fa-navicon fa-neuter fa-newspaper-o fa-object-group fa-object-ungroup fa-odnoklassniki fa-odnoklassniki-square fa-opencart fa-openid fa-opera fa-optin-monster fa-outdent fa-pagelines fa-paint-brush fa-paper-plane fa-paper-plane-o fa-paperclip fa-paragraph fa-paste fa-pause fa-pause-circle fa-pause-circle-o fa-paw fa-paypal fa-pencil fa-pencil-square fa-pencil-square-o fa-percent fa-phone fa-phone-square fa-photo fa-picture-o fa-pie-chart fa-pied-piper fa-pied-piper-alt fa-pinterest fa-pinterest-p fa-pinterest-square fa-plane fa-play fa-play-circle fa-play-circle-o fa-plug fa-plus fa-plus-circle fa-plus-square fa-plus-square-o fa-power-off fa-print fa-product-hunt fa-puzzle-piece fa-qq fa-qrcode fa-question fa-question-circle fa-question-circle-o fa-quote-left fa-quote-right fa-ra fa-random fa-rebel fa-recycle fa-reddit fa-reddit-alien fa-reddit-square fa-refresh fa-registered fa-remove fa-renren fa-reorder fa-repeat fa-reply fa-reply-all fa-retweet fa-rmb fa-road fa-rocket fa-rotate-left fa-rotate-right fa-rouble fa-rss fa-rss-square fa-rub fa-ruble fa-rupee fa-safari fa-save fa-scissors fa-scribd fa-search fa-search-minus fa-search-plus fa-sellsy fa-send fa-send-o fa-server fa-share fa-share-alt fa-share-alt-square fa-share-square fa-share-square-o fa-shekel fa-sheqel fa-shield fa-ship fa-shirtsinbulk fa-shopping-bag fa-shopping-basket fa-shopping-cart fa-sign-in fa-sign-language fa-sign-out fa-signal fa-signing fa-simplybuilt fa-sitemap fa-skyatlas fa-skype fa-slack fa-sliders fa-slideshare fa-smile-o fa-snapchat fa-snapchat-ghost fa-snapchat-square fa-soccer-ball-o fa-sort fa-sort-alpha-asc fa-sort-alpha-desc fa-sort-amount-asc fa-sort-amount-desc fa-sort-asc fa-sort-desc fa-sort-down fa-sort-numeric-asc fa-sort-numeric-desc fa-sort-up fa-soundcloud fa-space-shuttle fa-spinner fa-spoon fa-spotify fa-square fa-square-o fa-stack-exchange fa-stack-overflow fa-star fa-star-half fa-star-half-empty fa-star-half-full fa-star-half-o fa-star-o fa-steam fa-steam-square fa-step-backward fa-step-forward fa-stethoscope fa-sticky-note fa-sticky-note-o fa-stop fa-stop-circle fa-stop-circle-o fa-street-view fa-strikethrough fa-stumbleupon fa-stumbleupon-circle fa-subscript fa-subway fa-suitcase fa-sun-o fa-superscript fa-support fa-table fa-tablet fa-tachometer fa-tag fa-tags fa-tasks fa-taxi fa-television fa-tencent-weibo fa-terminal fa-text-height fa-text-width fa-th fa-th-large fa-th-list fa-thumb-tack fa-thumbs-down fa-thumbs-o-down fa-thumbs-o-up fa-thumbs-up fa-ticket fa-times fa-times-circle fa-times-circle-o fa-tint fa-toggle-down fa-toggle-left fa-toggle-off fa-toggle-on fa-toggle-right fa-toggle-up fa-trademark fa-train fa-transgender fa-transgender-alt fa-trash fa-trash-o fa-tree fa-trello fa-tripadvisor fa-trophy fa-truck fa-try fa-tty fa-tumblr fa-tumblr-square fa-turkish-lira fa-tv fa-twitch fa-twitter fa-twitter-square fa-ul fa-umbrella fa-underline fa-undo fa-universal-access fa-university fa-unlink fa-unlock fa-unlock-alt fa-unsorted fa-upload fa-usb fa-usd fa-user fa-user-md fa-user-plus fa-user-secret fa-user-times fa-users fa-venus fa-venus-double fa-venus-mars fa-viacoin fa-viadeo fa-viadeo-square fa-video-camera fa-vimeo fa-vimeo-square fa-vine fa-vk fa-volume-control-phone fa-volume-down fa-volume-off fa-volume-up fa-warning fa-wechat fa-weibo fa-weixin fa-whatsapp fa-wheelchair fa-wheelchair-alt fa-wifi fa-wikipedia-w fa-windows fa-won fa-wordpress fa-wpbeginner fa-wpforms fa-wrench fa-xing fa-xing-square fa-y-combinator fa-y-combinator-square fa-yahoo fa-yc fa-yc-square fa-yelp fa-yen fa-youtube fa-youtube-play fa-youtube-square false file-type font fontawesome-icon-list force form-control function gender github great hacks hand height hello hidden holder href html https icon icons indicate instantly io issue itesoft js line-height ll maincontroller margin-bottom-lg margin-bottom-none medical message modify module multiline names ng-controller nowrap org owners padding-left padding-left-lg page-header payment player power product refer remove represent respective row scalable setting shadow size social socialmedia spinner sr-only text-editor text-muted text-overflow title tooltip trademark trademarks transportation true type vector versa vice video-player warning web-application white-space work"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$log $scope $timeout account adding allow angular api applies appscope autocomplete availablestax biens blur btn call carney cellclass changed class classes click code col col-xs-12 col-xs-3 col-xs-9 colfilter columndefs columns company companyid comveyer container content controller converter copy core cox custom customoptions custompredicate d20 d5 data de_19 de_26 de_27 de_7 debug default description directive directly dirty disabled div eca emit employed enablefiltering end_date enormo enormo1 enormo10 enormo11 enormo12 enormo2 enormo3 enormo4 enormo5 enormo6 enormo7 enormo8 enormo9 event event-refresh event-select example false field fields filter filterchanged filterheadertemplate filters filteruse firstcode firstevent firstname firstnamefilter firstnameoptions firstrate fn focus force foreach fr fr_10 fr_19 fr_20 fr_22 fr_23 fr_24 fr_25 fr_7 fuelton function getcode getidfromobject getlabelfromobject getobject getrate getter grid grid1 gridapi gridoptions homectrl html implements indexof info input input-class inside instantiate isdefined isundefined it-autocomplete it-autocomplete-btn it-autocomplete-container it-autocomplete-div it-autocomplete-div-visible it-autocomplete-input it-autocomplete-select it-autocomplete-selected itautocomplete item items items-getter itemtotest itesoft itesoft-showcase js juridiction key label lastname lastnamefilter lastnameoptions lazygrid length link list lorraine map method module mydata mydatainit nancy ng-controller ng-model ng-repeat ngmessages null object objectautocomplete offset_account offset_tax on-blur on-change on-focus onregisterapi option option-container-class options param parameter params parent placeholder predicate premiere push rate readonly reference refresh result resultitem return row sample search search-mode searchmode searchpredicate secondcode secondevent secondrate selected selected-option selectedid selectedoption selectedtax services start_date startswith structural style suggestions table taux tax taxconverter term test text totalitems transform true tva tva_fr tva_fr_old tvas type ui-grid ui-grid-filter-container unable undefined usage useexternalfiltering user values var visible waters widgets width300 wise"
    },
    {
      "section": "api",
      ...
      "keywords": "$http $rootscope $scope add addnewline admin allowoverride angular api autologin block bottom btn btn-danger btn-primary button carney cellclass celltemplate class coding coding-lines-add3 coding-lines-duplicate3 coding-lines-memorize3 coding-lines-remove3 codingcontroller col-xs-2 columndefs company comveyer config configfile controller copy core cox current_package current_role customize data default defaultnamespace directive dirty disabled duplicate duplicateline eac editmode editor editsite email employed enable enable_template_editor enablefiltering enormo example fa fa-copy fa-folder fa-lg fa-plus fa-trash false filter filterchanged filteruse firstname floating-label foreach form-control form-group fuelton function grid grid1 gridapi gridoptions homectrl html http initialize it-autocomplete it-input it-label itconfig itconfigprovider itesoft itesoft-showcase js json key lastname left length lines login login_input lorraine managed margin memorize modification module mydata mydatainit nancy ng-click ng-controller ng-model ngresource onregisterapi package password ps remove removed removenewline rest rest_template_api_url role sample saved selectedoption skip skip_login style template template_editor_url template_user_auto_login text title toaster totalitems translate true type ui ui-grid ui-grid-cell-contents uigridgroupingconstants url useexternalfiltering user usrole v1 values var version waters web widgets wise zone-coding-lines-actions3 zone-firstname zone-grid-example"
    },
    {
      "section": "api",
      "id": "itesoft.directive:itBlockControlPanel",
      "shortName": "itBlockControlPanel",
      "type": "directive",
      "moduleName": "itesoft",
      "shortDescription": "The Control Panel Block widgets provides a way to activate it-block edition",
      "keywords": "$rootscope $scope activate admin allowoverride angular api app block bottom class config configfile confirm control controller current_package current_role customize default defaultnamespace delete directive edit edition editor editsite enable_template_editor function global homectrl html http initialize it-block itconfig itconfigprovider itesoft itesoft-showcase js json left login module ngresource panel password pilot ps readonly rest_editor_api_url rest_template_api_url skip_login style template template_editor_url template_user_auto_login title toaster true url v1 values version web widgets"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$broadcast $scope _removeitems add addnewitem angular api application appscope attributes auto automatically binding bootstrap btn btn-danger btn-info btn-primary btn-success btn-warning button_lang_en buttons changed changes check checkbox child class code columndefs columns container content context controller copy css currentitem currentitemwrapper data datalist default define delete deleteselecteditems description detail details directive disablemultiselect display displayed displayname ea editing element elements empty enable enabledde encompass entire entity equals event fa fa-chevron-down fa-chevron-up fa-file-code-o fa-floppy-o fa-lg fa-plus fa-trash fa-undo false field fillheight filter floating-label foo forbidden foreach form-control form-group fr function getcurrentitemwrapper getfiltereditems getselecteditems grid haschanged height html indexof initstate it-col it-input it-label it-lang it-lock-on-change it-master-data it-master-detail-control it-no-data-msg it-no-detail-msg it-search-placeholder it-toggle itappscope item items itesoft js length list lockcurrentitem main master master-detail master_row_changed masterdetailcontroller masterdetails menu modal mode module multiple mymasterdetailcontrol navalert navigate navigation newitem ng-click ng-controller ng-disabled ng-model ng-required null object ontap original parent pass passed popup prioritycategory prioritydescription promise push recherche refresh return revert row save savecurrentitem scope scroll scrolltoitem selectable selected selection set setcurrentitem sortable splice src table template test tete text title translate trigged triggered true type undefined undo undochange undochangecurrentitem unlock unlockcurrentitem unlockonequals unsaved var wrapper"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "moduleName": "itesoft",
      "shortDescription": "",
      "keywords": "$scope $translate aec alert allow angular angular-ui-layout api apply args bar border-color border-style border-width case center change class click col-md-12 console controller cross current directive document domain downloadprogress error extension false fit_height fit_page fit_width force function getapi getcurrentpage getnumpages getzoomlevel getzoomlevels github gotonextpage gotopage gotoprevpage guess height homectrl horizontal html http implement initial initialscale io items itesoft itesoft-showcase js layout left level levels libpath list log media menu message module multipage-viewer ng-controller notify num-page number onapiloaded onerror onpageclicked onpagerotation ontemplatenotfound onzoomlevelschanged onzoomtoselection options orientation origin pageindex parameter passed pdf prev progress property rectangle red rendertextlayer rotate rotatepageleft rotatepageright rotatepagesleft rotatepagesright rotation row scale selected selection server showprogressbar showsizemenu showthumbnail showtoolbar size solid src style table template text-align thumbnail thumbnail-viewer tool tracemonkey-pldi-09 translate true type url vertical viewer zoom zoomin zoomout zoomto"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$scope $translate allows angular api asks browser btn btn-warning button callback cancel change changelanguage changing class code config configuration confirmation consuming controller culture current currentlanguage data default display en en_gb example features function getconfig getcurrentlanguage getdefaultlocale getlanguagecode html initial initiallanguage itesoft itlanguagechangehandler itlanguagechangehandlerprovider itpopup js label language languagechanged local locale localstorage localstorageservice localstorageserviceprovider maincontroller method modifies module ng-click ng-controller ng-model option optional options parameter popup promise query receive returned scope service set setprefix setting storage stores string table text title true type updated url var"
    },
    {
      "section": "api",
      "id": "itesoft.service:itMessaging",
      "shortName": "itMessaging",
      "type": "service",
      "moduleName": "itesoft",
      "shortDescription": "Service that provide all functions to connect and  dialog with itesoft-messaging system.",
      "keywords": "$http $log $q $scope $textmessage $timeout $websocket _scrolltobottom _textmessageextractor angular api api_key arge args arguments arrive automatically backend bad base_url body bottom btn btn-primary callback chat class code col-md-6 col-md-offset-3 col-xs-12 col-xs-6 col-xs-offset-3 comment-o commonly config connect connexion content controller conversation conversation-content created creationdate data detail dialog disabled dismissontimeout displayname document don error establish example_source_hi- exec exist fa fa- fa-minus-square-o fake fakenotifierservice false fbd0ca6b-e3e4-47e3-952a-c0e7630f9932 filter floating-label floor foreach form-control form-group format function functions getelementbyid gettoken group groups happened height hh href html http icndb icon icons indexof info input interupted invoices invoices_topic isconnected it-fill it-input it-label it-messaging-chat it-messaging-message it-messaging-notification it-messaging-tag itesoft itesoft-messaging itmessaging itmessagingprovider itmsg itnotifier javascript joke js json jumbotron key label label-info left length list localhost login main maincontroller math message message-text messageform messages messagetext method module myarray myform mymodule naming ng-class ng-click ng-controller ng-if ng-maxlength ng-model ng-repeat ng-submit notification notification-content notifyerror novalidate null observer observers onclose onmessage orderby overflow overflow-x overflow-y pass popup promise protocol provide pull-left push random received recipient reference regex regexp registred replace represent required response result return returned row row-height-1 row-height-2 row-height-6 row-height-8 row-height-9 s-1 s-10 s-11 s-12 s-13 s-14 s-15 s-16 s-17 s-18 s-19 s-2 s-20 s-21 s-22 s-23 s-24 s-25 s-26 s-27 s-28 s-29 s-3 s-30 s-31 s-32 s-33 s-34 s-35 s-36 s-37 s-38 s-39 s-4 s-40 s-41 s-42 s-43 s-5 s-6 s-7 s-8 s-9 sarrayv sbrace sbracket scolon scomma scroll scroller1 scroller2 scrollheight scrolltop selectcurrenttopic selectedtopic sender senderid sendmessage service service_url settimeout showcase_topic slice small sobjectk sobjectv some-icon-to-render sort split start startnotify startswith stringresult structure-1 structure-2 style submit subscribe subscribetotopic substring success system tabindex table text title toaster token topic topicname topics tostring triggered true tstbuydpoc01 type unregistred unsubscribe unsubscribetotopic url user username users var wanna warning websocket width youbusinesskey youbusinesskey2 yyyy-mm-dd"
    },
    {
      "section": "api",
