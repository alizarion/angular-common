NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$log $scope $timeout account adding allow angular api applies appscope autocomplete availablestax biens call carney cellclass class classes click code col col-xs-12 col-xs-3 col-xs-9 colfilter columndefs columns company companyid comveyer container content controller converter copy core cox custom customoptions custompredicate d20 d5 data de_19 de_26 de_27 de_7 debug default description directive directly dirty div eca emit employed enablefiltering end_date enormo enormo1 enormo10 enormo11 enormo12 enormo2 enormo3 enormo4 enormo5 enormo6 enormo7 enormo8 enormo9 error event event-refresh event-select example false field filter filterchanged filterheadertemplate filters filteruse firstcode firstevent firstname firstnamefilter firstnameoptions firstrate fn force foreach fr fr_10 fr_19 fr_20 fr_22 fr_23 fr_24 fr_25 fr_7 fuelton function getcode getidfromobject getlabelfromobject getobjectfromid getrate getter grid grid1 gridapi gridoptions homectrl html indexof input-class inside instantiate isdefined isundefined it-autocomplete it-autocomplete-container it-autocomplete-div it-autocomplete-select it-autocomplete-selected itautocomplete item items items-getter itemtotest itesoft itesoft-showcase js juridiction key lastname lastnamefilter lastnameoptions lazygrid length link list lorraine map method module mydata mydatainit nancy ng-controller ng-model ng-repeat ngmessages null object objectautocomplete offset_account offset_tax onregisterapi option option-container-class options param parameter params parent placeholder predicate premiere push rate reference refresh result return row sample search search-mode searchmode searchpredicate secondcode secondevent secondrate selected selected-option selectedid selectedoption selectedtax services start_date startswith structural style suggestions table taux tax taxconverter term text totalitems true tva tva_fr tva_fr_old tvas type ui-grid ui-grid-filter-container unable undefined usage useexternalfiltering user values var waters widgets width300 wise"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "moduleName": "itesoft",
      "shortDescription": "Provide a circular button like for the full screen button",
      "keywords": "$scope aec angular api button circular controller directive fit_height full function github homectrl html http initialscale io itesoft itesoft-showcase js module ng-controller options pdf provide rendertextlayer screen showtoolbar src tracemonkey-pldi-09 true"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "accusantium active add adipisicing allows amet anglais api area atque blanditiis btn button caret center child class collapse consectetur consequuntur container container-fluid content directive directives divider doe dolor dothraki dragging dropdown-menu earum eca eius element elements elit encompass enim eum fa fa-list fa-music fa-pied-piper-alt fran glyphicon glyphicon-ok glyphicon-user header href html illum impedit ipsum it-animate it-button-menu it-collapsed-item it-hide-button-menu it-menu-animated it-nav-active itesoft laboriosam left libero list-group loginbutton logout main menu menu-- menus modi module nav nav-pills nav-stacked navbar-collapse navbar-nav navbar-right nemo ng-cloak parent provident pull-right qui ratione role side sit toggled totam translate true type uib-dropdown uib-dropdown-toggle ullam veritatis"
    },
    {
      "section": "api",
