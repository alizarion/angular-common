NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "moduleName": "itesoft",
      "shortDescription": "",
      "keywords": "$scope aec allow angular api apply bar case class col-md-12 console controller cross current directive disable document domain downloadprogress enable false fit_height fit_page fit_width force function getcurrentpage getnumpages getzoomlevel getzoomlevels github gotonextpage gotopage gotoprevpage guess height homectrl html http implement initial initialscale io items itesoft itesoft-showcase js layer left level libpath list log media module ng-controller notify number onapiloaded options origin parameter passed pdf prev progress property render rendertextlayer rotate rotatepageleft rotatepageright rotatepagesleft rotatepagesright row scale server showprogressbar showtoolbar src style table text tool tracemonkey-pldi-09 true type url viewer zoom zoomin zoomout zoomto"
    },
    {
      "section": "api",
