NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$log $scope adding allow angular api applies appscope autocomplete call carney cellclass class classes click code col col-xs-12 col-xs-3 col-xs-9 colfilter columndefs columns company comveyer container controller copy core cox custom customoptions custompredicate data de_19 de_26 de_27 de_7 debug default description directive dirty div eca emit employed enablefiltering enormo enormo1 enormo10 enormo11 enormo12 enormo2 enormo3 enormo4 enormo5 enormo6 enormo7 enormo8 enormo9 event event-refresh event-select example false field filter filterchanged filterheadertemplate filters filteruse firstcode firstevent firstname firstnamefilter firstnameoptions firstrate fn force foreach fr_10 fr_19 fr_20 fr_22 fr_23 fr_24 fr_25 fr_7 fuelton function getcode getrate getter grid grid1 gridapi gridoptions homectrl html indexof input-class inside instantiate isundefined it-autocomplete it-autocomplete-container it-autocomplete-div it-autocomplete-select it-autocomplete-selected itautocomplete item items items-getter itemtotest itesoft itesoft-showcase js key lastname lastnamefilter lastnameoptions lazygrid length link list lorraine method module mydata mydatainit nancy ng-controller ng-model ng-repeat ngmessages object onregisterapi option option-container-class options param parameter params parent placeholder predicate premiere push rate reference refresh result return row sample search search-mode searchmode searchpredicate secondcode secondevent secondrate selected selected-option selectedid selectedoption startswith structural style suggestions table taux term text totalitems true tva tva_fr tva_fr_old tvas type ui-grid ui-grid-filter-container undefined usage useexternalfiltering user values var waters widgets width300 wise"
    },
    {
      "section": "api",
