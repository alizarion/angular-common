NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "moduleName": "itesoft",
      "shortDescription": "A container element for master-detail main content.",
      "keywords": "$broadcast $scope _removeitems add addnewitem angular api application appscope attributes auto binding btn btn-danger btn-info btn-primary btn-success btn-warning button_lang_en changed changes check checkbox child class code columndefs container content context controller css currentitem currentitemwrapper data datalist default define delete deleteselecteditems description detail details directive display displayed displayname ea editing element elements empty enabledde encompass entity equals fa fa-chevron-down fa-chevron-up fa-file-code-o fa-floppy-o fa-lg fa-plus fa-trash fa-undo false field fillheight filter floating-label foo forbidden foreach form-control form-group fr function getcurrentitemwrapper getfiltereditems getselecteditems grid haschanged height html indexof it-en it-input it-lang it-lock-on-change it-master-data it-master-detail-control it-search-placeholder it-text it-toggle itappscope item items itesoft js length list lockcurrentitem main master master-detail masterdetailcontroller masterdetails menu modal mode module mymasterdetailcontrol navalert navigate navigation newitem ng-click ng-controller ng-disabled ng-model ng-required null object original parent pass passed popup prioritycategory prioritydescription promise push recherche refresh return revert row save savecurrentitem scope scroll scrolltoitem selectable selected set setcurrentitem sortable splice src table template test tete text title translate triggered true type undo undochange undochangecurrentitem unlock unlockcurrentitem unlockonequals unsaved var width wrapper"
    },
    {
      "section": "api",
