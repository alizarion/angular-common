NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$broadcast $scope _removeitems add addnewitem angular api appear application appscope auto binding btn btn-danger btn-info btn-primary btn-success btn-warning button_lang_en changed changes check checkbox child class code columndefs container content context controller css currentitem currentitemwrapper data datalist default define delete deleteselecteditems description detail details directive display displayed displayname ea editing element elements enabledde encompass entity equals fa fa-chevron-down fa-chevron-up fa-file-code-o fa-floppy-o fa-lg fa-plus fa-trash fa-undo false field fillheight filter floating-label foo foreach form-control form-group fr function getcurrentitem getcurrentitemwrapper getfiltereditems getselecteditems grid haschanged height html indexof it-en it-input it-lang it-lock-on-change it-master-data it-master-detail-control it-search-placeholder it-text it-toggle itappscope item items itesoft itesoft-showcase js length list lockcurrentitem main master master-detail masterdetailcontroller masterdetails menu mode module navalert newitem ng-click ng-controller ng-disabled ng-model ng-required null original parent prioritycategory prioritydescription promise push recherche refresh return revert row save savecurrentitem scope scroll scrolltoitem selectable selected set setcurrentitem sortable splice src table template test tete text title translate true type undo undochange undochangecurrentitem unlock unlockcurrentitem unlockonequals var width"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$scope addition alert alertpopup allowing allows angular api bootstrap btn btn-danger btn-info btn-warning built callback canceled class completely confirm confirmpopup content continue controller creating custom data deps directive eca flexible function functions html inputlabel inputtype itesoft itesoft-showcase itpopup js lib min module ng-click ng-controller order password popup popup_content popup_label popup_title popupctrl popups programmatically prompt promptpopup require respond response service showalert showconfirm showing showprompt support system text title translate ui user users validate var vendor versions windows"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "api container directive false header it-hide-button-menu itesoft menu side sidemenus true"
    },
    {
      "section": "api",
    ...
    {
      "section": "api",
      "id": "itesoft.directive:masterDetail",
      "shortName": "masterDetail",
      "type": "directive",
      "moduleName": "itesoft",
      "shortDescription": "A container element for master-detail main content.",
      "keywords": "$broadcast $scope _removeitems active add addnewitem angular api appear application appscope auto binding body btn button_lang_en celltemplate changed changes check checkbox child class code columndefs container content context controller css currentitem currentitemwrapper data datalist default define delete deleteselecteditems description detail details directive display displayed displayname ea editing element elements email enabledde encompass entity equals fa fa-chevron-down fa-chevron-up fa-file-code-o fa-floppy-o fa-lg fa-plus fa-trash fa-undo false field fillheight filter floating-label foo foreach form-control form-group fr function getcurrentitem getcurrentitemwrapper getfiltereditems getselecteditems grid haschanged height html indexof initstate it-input it-lang it-lock-on-change it-master-data it-master-detail-control it-no-data-msg it-no-detail-msg it-search-placeholder it-text it-toggle itappscope item items itesoft itesoft-showcase js length list lockcurrentitem logfiltereditems main master master-detail masterdetailcontroller masterdetails menu mode module navalert newitem ng-class ng-click ng-controller ng-disabled ng-model ng-required ngcelltext ngroute null original parent promise push recherche refresh retrieveclass return revert row save savecurrentitem scope scroll scrolltoitem selectable selected set setcurrentitem sortable splice src table template test tete text title translate true type undo undochange undochangecurrentitem unlock unlockcurrentitem unlockonequals var width"
    },
    {
      "section": "api",
      "id": "itesoft:itDetail",
