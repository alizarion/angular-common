NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "adipisicing alias amet aperiam api applied assumenda autem auto awesome background-color bar beatae blanditiis blue bootstrap btn btn-default btn-success button center class columns commodi consectetur container content covers css culpa cum cumque custom default delectus dignissimos directive display div dolor dolorem element elements elit equal fa-star-o facilis font footer full gray greater green harum header height hic highest html icon icons ipsam ipsum it-col it-height-mode it-icon-class it-side-panel it-side-panel-button it-side-panel-container it-side-panel-footer it-top-position it-z-index itesoft iusto laboriosam lorem magnam margin mode module neque nobis number override panel panel-- position property provident quaerat quas qui repudiandae saepe scroll selector set side similique sit site smaller suscipit table table-cell tempora tempore tenetur text-align theside top totam unde undefined vel velit vertical-align view width window xx z-index"
    },
    {
      "section": "api",
