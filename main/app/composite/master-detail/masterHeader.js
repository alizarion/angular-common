                            ...
                            '<div>'+
                                '<form>'+
                                    '<div class="form-group has-feedback" >'+
                                        ...
                                        '<input it-input ng-change="$parent.refreshData()" class="form-control floating-label" type="text" ng-model="$parent.filterText" class="form-control floating-label" it-text="{{itSearchPlaceholder}}"/>'+
                                    '</div>'+
                                '</form>'+
                            '</div>'+
                        '</div>',
