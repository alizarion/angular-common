    ...
    [
        function () {
            return {
                ...
                '<span ng-if="!itBlockControlPanelController.focusable" class="block-control-panel-help">(Press Ctrl and move your mouse over a block to select it)</span>' +
                '<span ng-if="itBlockControlPanelController.focusable" class="block-control-panel-help">(Release Ctrl over an element to select it)</span>' +
                '</div>' +
